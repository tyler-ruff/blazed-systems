...
<template>
    <footer class="bg-white select-none border-t">
      <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div class="flex justify-center sm:justify-start">
                <nuxt-link class="group" href="/" v-bind:title="siteConfig.name">
                    <img src="/images/beaker-dark.png" width="35" height="35" class="inline-flex group-hover:opacity-75" />
                    <span class="inline-flex text-2xl pl-2 font-bold text-gray-600 group-hover:text-gray-400">
                        {{ siteConfig.name }}
                    </span>
                </nuxt-link>
            </div>
            ...
            <ul class="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
              <li>
                <nuxt-link
                  v-bind:href="socialConfig.facebook"
                  rel="noreferrer"
                  target="_blank"
              ...
              <li>
                <nuxt-link
                  v-bind:href="socialConfig.instagram"
                  rel="noreferrer"
                  target="_blank"
                  class="text-gray-700 transition hover:text-gray-700/75"
                >
              ...
              <li>
                <nuxt-link
                  v-bind:href="socialConfig.twitter"
                  rel="noreferrer"
                  target="_blank"
                  class="text-gray-700 transition hover:text-gray-700/75"
                >
              ...
              <li>
                <nuxt-link
                  v-bind:href="socialConfig.github"
                  rel="noreferrer"
                  target="_blank"
                  class="text-gray-700 transition hover:text-gray-700/75"
                >
            ...
            <div class="text-center sm:text-left">
              ...
              <ul class="mt-8 space-y-4 text-sm">
                ...
                <li>
                  <nuxt-link
                    class="text-gray-700 transition hover:text-gray-700/75"
                    href="https://blazedlabs.com/blog"
                  >
                    Blog
                  </nuxt-link>
                </li>
            ...
            <div class="text-center sm:text-left">
              ...
              <ul class="mt-8 space-y-4 text-sm">
                ...
                <li>
                  <nuxt-link
                    class="text-gray-700 transition hover:text-gray-700/75"
                    href="https://blazed.contact/support"
                  >
                    Support
                </nuxt-link>
                </li>
                ...
                <li>
                  <nuxt-link
                    class="group flex justify-left gap-1.5"
                    href="https://blazed.contact/live-chat"
                    target="_blank"
                  >
                    <span
              ...
              <ul class="mt-8 space-y-4 text-sm">
                <li>
                  <nuxt-link
                    ...
                    v-bind:href="`mailto:${brandConfig.email}`"
                  >
                    <svg
                    ...
                    <span class="flex-1 text-gray-700">{{ brandConfig.email }}</span>
                </nuxt-link>
                </li>
                ...
                <li>
                  <nuxt-link
                    class="flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end"
                    v-bind:href="`tel:${brandConfig.telephone}`"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-5 w-5 shrink-0 text-gray-900"
        ...
        <div class="mt-12 border-t border-gray-100 pt-6">
          <div class="text-center sm:flex sm:justify-between sm:text-left">
            <p class="text-sm text-gray-500">
              ...
              <a
                class="inline-block text-gray-600 hover:underline transition hover:text-gray-600/75"
